...
- [x] **P0**: Each escalation gets exactly one next step
...
- [x] **P0**: The decider acts only within fixed authority
...
- [x] **P1**: A periodic review keeps the findings index small and honest
