...
**Out**
- the thin loop driver, handoff files and implementer checkpoints, which are later redesign features, and loop measurement (`loop-measurement`), which is built before this
